...
class fetchComments2:

    def extract(self, page_id, post_id):

        graph_api_version = 'v2.11'
        access_token = 'EAAQeze2hQ94BAMEBGFa7IY59E6DQFtkMeJH1V85TmiWiQ6wbpw1ei4CFNol3ZBrQUrxKvM6GBA1VXXGyCa6wjMO7tvZABJdPZBQRqH1FZAtuXYFtGpZBAGCZBn8x1CuQyZCyrNnF3hmUuGtB7US8dOQALrxVA7QxeowaV2ZBJ4wCZBwZDZD'
